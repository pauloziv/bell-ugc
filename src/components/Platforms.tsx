  ...
  const platforms = [
    {
      ...
      desc: "Reels dinâmicos, stories interativos e feed com estética cuidada para engajar sua audiência.",
      icon: InstagramLogo,
    ...
    },
    {
      ...
      desc: "Conteúdo nativo, tendências e trends adaptadas para máximo alcance orgânico.",
      icon: TiktokLogo,
