...
const CASES: Brand[] = [
  ...
  },
  {
    ...
    result: "Cuidado real",
    desc: "UGC de rotina — pele, ritual e conversa de banheiro. Cuidado de verdade, sem cara de studio.",
    tilt: "rotate-[3deg]",
    plate: "bg-[#F4EFE6]",
    knockout: false,
  },
  {
    name: "Muvon",
    logo: "/images/brands/muvon.svg",
    result: "Café proteico",
    desc: "Rotina com café proteico gelado — academia, trabalho, lanche da tarde. UGC que cabe no dia.",
    tilt: "rotate-[-4deg]",
    plate: "bg-[#FBF8F2]",
    knockout: false,
  },
